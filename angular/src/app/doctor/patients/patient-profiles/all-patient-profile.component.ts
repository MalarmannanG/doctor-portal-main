...
@Component({
  selector: "app-all-patient-profile",
  templateUrl: "./all-patient-profile.component.html",
  styleUrls: ["./all-patient-profile.component.sass"],
})
export class AllPatientProfileComponent
