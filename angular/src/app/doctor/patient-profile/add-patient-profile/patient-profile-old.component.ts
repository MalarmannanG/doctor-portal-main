...
@Component({
  selector: "app-patient-profile-old",
  templateUrl: "./patient-profile-old.component.html",
  styleUrls: ["./patient-profile-old.component.scss"],
})

export class PatientProfileOldComponent implements OnInit, OnDestroy {
  docForm: FormGroup;
  hide3 = true;
  step: number = 0;
