...
export class ValidationMessagesComponent {
    ...
    readonly standartErrorDefs: ErrorDef[] = [
        { error: 'required', localizationKey: 'This field is required' } as ErrorDef,
        ...
        { error: 'email', localizationKey: 'Invalid email address' } as ErrorDef,
        { error: 'pattern', localizationKey: 'Invalid pattern', errorProperty: 'requiredPattern' } as ErrorDef
    ];
